...
class AISystem(nn.Module):   
    ...
    def generate_response(self, combined_context, user_input):
        ...
        prompt = [{'role': 'user', 'content': f"{user_input} {combined_context}"}]
    ...
    def process_input(self, input_text, _CLASS_NAMES):
        ...
        final_response = self.generate_response(combined_context, user_input)
    ...
    def perform_sentiment_analysis(self, input_text, _CLASS_NAMES):
        ...
        return f"Detected sentiment: {sentiment_label}"
...
ai_system = AISystem()
user_input = "How would you leverage AI to develop and implement lucrative business ventures?"
